            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="contentDetailsForm" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="title" class="form-label">Titolo</label>
                            <input type="text" class="form-control form_input_focused" id="edit-title"
                                name="title">
                        </div>
                        <div class="mb-3">
                            <label for="subtitle" class="form-label">Sottotitolo</label>
                            <input type="text" class="form-control form_input_focused" id="edit-subtitle"
                                name="subtitle">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="links" class="form-label">Links</label>
                            <input type="text" class="form-control form_input_focused" id="edit-links"
                                name="links">
                        </div>
                        <div class="mb-3">
                            <label for="order" class="form-label">Ordine</label>
                            <input type="number" class="form-control form_input_focused" id="edit-order"
                                name="order">
                        </div>
                        <div class="mb-3">
                            <label for="editShow" class="form-label">Mostra</label>
                            <select name="show" id="edit-show" class="form-select"
                        ...
                        <div class="mb-3">
                            <label for="images" class="form-label">Immagini</label>
                            <input type="file" class="form-control form_input_focused" id="edit-images"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll('.open-details-modal').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    form.querySelector('#edit-title').value = content.title;
                    form.querySelector('#edit-subtitle').value = content.subtitle;
                    form.querySelector('#edit-body').value = content.body;
                    form.querySelector('#edit-links').value = content.links;
                    form.querySelector('#edit-order').value = content.order;
                    form.querySelector('#edit-show').value = page.show ? '1' : '0';

                    // Inizializza TinyMCE per il campo body nel modale
                    tinymce.get('edit-body').setContent(content.body);
