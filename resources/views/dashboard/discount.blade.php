<x-dashboard-layout>
    <div class="container">
        ...
        <form id="discountForm" method="POST" action="{{ route('discounts.store') }}">
            ...
            <div class="mb-3">
                <label for="name" class="form-label">Nome Sconto</label>
            ...
            <div class="mb-3">
                ...
                <div id="discount_periods">
                    <div class="row mb-2 discount-period">
                        <div class="col-5">
                            <input type="datetime-local" class="form-control" name="periods[0][start]" required>
                        </div>
                        <div class="col-5">
                            <input type="datetime-local" class="form-control" name="periods[0][end]" required>
                        </div>
                        <div class="col-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-warning editDiscount" data-id="{{ $discount->id }}"
                                data-name="{{ $discount->name }}" data-percentage="{{ $discount->percentage }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editDiscountForm" method="POST"
                            ...
                            <div class="mb-3">
                                <label for="edit_name" class="form-label">Nome Sconto</label>
