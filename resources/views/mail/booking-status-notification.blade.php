    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:600px) {
            ...
            *[class="gmail-fix"] {
            ...
            .es-text-1106 .es-text-mobile-size-16,
            .es-text-1106 .es-text-mobile-size-16 * {
                font-size: 16px !important;
                line-height: 150% !important
            }
                                ...
                                <table class="es-header-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <!--[if mso]></td><td style="width:222px" valign="top"><![endif]-->
                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left"
                                                role="none"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                                <tr>
                                                    <td class="es-m-p20b" align="left"
                                                        style="padding:0;Margin:0;width:222px">
                                            ...
                                            <!--[if mso]></td><td style="width:20px"></td><td style="width:124px" valign="top"><![endif]-->
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-text-1106"
                                                                    ...
                                                                    <p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:32px !important;letter-spacing:0;color:#333333;font-size:16px"
                                                                        class="es-text-mobile-size-16">
                                                                        {!! __('ui.bookingStatusUpdate', ['status' => __('ui.' . $booking->status)]) !!}.</p>
                                                                    <p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:32px !important;letter-spacing:0;color:#333333;font-size:16px"
                                                                        class="es-text-mobile-size-16"></p>
                                                                    <p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:32px !important;letter-spacing:0;color:#333333;font-size:16px"
                                                                        class="es-text-mobile-size-16">​</p>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __('ui.bookingStatusMessage') }} <a
                                                                            href="{{ route('booking.status', ['booking' => $booking, 'locale' => $booking->locale]) }}">{{ __('ui.clickHere') }}</a>​
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="Margin:0;padding-top:20px;padding-right:20px;padding-left:20px;padding-bottom:20px"><!--[if mso]>
